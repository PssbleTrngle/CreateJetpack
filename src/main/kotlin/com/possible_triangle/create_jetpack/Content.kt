...
object Content {
    ...
    val JETPACK_ITEM: ItemEntry<JetpackItem> =
        REGISTRATE
            .item("jetpack") {
                JetpackItem(
                    it,
    ...
    val JETPACK_PLACEABLE: ItemEntry<BacktankBlockItem> =
        REGISTRATE
    ...
    val JETPACK_BLOCK: BlockEntry<JetpackBlock> =
        REGISTRATE
    ...
    val NETHERITE_JETPACK_ITEM: ItemEntry<JetpackItem> =
        REGISTRATE
    ...
    val NETHERITE_JETPACK_PLACEABLE: ItemEntry<BacktankBlockItem> =
        REGISTRATE
    ...
    val NETHERITE_JETPACK_BLOCK: BlockEntry<JetpackBlock> =
        REGISTRATE
    ...
    fun <T : Block, P> BlockBuilder<T, P>.jetpackTransforms(getItem: () -> Item) =
        apply {
            blockstate { c, p ->
                val model =
                    p
    ...
    fun <T : Item, P> ItemBuilder<T, P>.jetpackProperties() =
        apply {
            model { c, p ->
                p
